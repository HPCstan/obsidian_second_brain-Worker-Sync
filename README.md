...
### 2. 🎬 YouTube 與 Shorts 影片極致收藏與「內嵌沉浸播放 + 自動時間軸全量字幕」
...
- **✨ 全自動分秒時間軸語音字幕 (Timestamped Transcripts)**：無須任何第三方付費 API 或帳號認證，後台 Worker 自帶 YouTube 內建 `captionTracks` 軌道解析引擎！
  - **雙語智慧排序**：自動依序挑選 **繁體中文 -> 英文 -> 預設語言** 的 CC 封閉/自動生成字幕。
  - **對話清單整理**：把字幕逐段精緻整為 **`[00:15]`、`[01:23]` 列表條目** 擺放在播放器正下方，供您邊賞片、邊隨興劃重點與筆記萃取！
